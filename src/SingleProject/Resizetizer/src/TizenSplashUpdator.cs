...
namespace Microsoft.Maui.Resizetizer
{
	public class TizenSplashUpdator : Task
	{
		...
		const string xmlNamespace = "http://tizen.org/ns/packages";
		...
		public void UpdateManifest()
		{
			...
			nsmgr.AddNamespace("manifest", xmlNamespace);
			...
			var splashScreensNode = doc.CreateElement("splash-screens", xmlNamespace);
			uiApplicationNode.AppendChild(splashScreensNode);

			foreach(var image in splashDpiMap)
			{
				var splashScreenNode = doc.CreateElement("splash-screen", xmlNamespace);
				...
				splashScreenNode.SetAttribute("orientation", "portrait");
